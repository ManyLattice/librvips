#
#  Be sure to run `pod spec lint libvips.podspec' to ensure this is a
...
s.description  = <<-DESC
Provides libvips libraries
DESC

s.homepage     = "http://EXAMPLE/libvips"
...
s.source       = { :git => "https://github.com/ManyLattice/libvips.git", :tag => "#{s.version}" }
